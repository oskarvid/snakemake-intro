...
tie %Config, 'Config', {
    archlibexp => relocate_inc('.../../lib/5.30.3/x86_64-linux-thread-multi'),
    ...
    osname => 'linux',
    osvers => '4.15.0-1092-azure',
    path_sep => ':',
    privlibexp => relocate_inc('.../../lib/5.30.3'),
    scriptdir => '.../',
    sitearchexp => relocate_inc('.../../lib/site_perl/5.30.3/x86_64-linux-thread-multi'),
    sitelibexp => relocate_inc('.../../lib/site_perl/5.30.3'),
    so => 'so',
    useithreads => 'define',
